// Editable legal content for the mobile app.
// EDIT THESE STRINGS to update your Terms of Service and Privacy Policy.
// Keep them accurate to your actual data-handling practices. Update the
// `lastUpdated` date whenever you change the text.
...
This Privacy Policy (the "Policy") describes how Sun Ray LLC, an Arizona limited liability company ("Sun Ray LLC," "Company," "we," "us," or "our"),
collects, uses, discloses, stores, retains, and otherwise processes Personal Information in connection with the Light Rail Deals mobile application, the website
located at lightraildeals.com, and all related services, features, content, communications, and backend systems (collectively, the "Services"). This Policy is
intended to provide clear notice regarding our privacy practices and your rights and choices with respect to your Personal Information.

By downloading, installing, registering for, accessing, or using the Services, you acknowledge that you have read and understood this Policy. Where consent is
required by applicable law, you consent to the processing of your Personal Information as described in this Policy. If you do not agree to this Policy, you must not
...
1. "Aggregate Data" means information combined with information from other users and analyzed as a group such that an individual cannot reasonably be
identified.
2. "Anonymous Data" means information that is not associated with or linked to Personal Information and that does not, by itself, permit the identification of
an individual.
3. "App" means the Light Rail Deals mobile software application, including all updates, upgrades, bug fixes, patches, and modifications.
4. "Backend" means the server-side infrastructure, databases, APIs, application logic, and related systems supporting the Services and operated by Sun
Ray LLC or on its behalf.
5. "Data Subject" means an identified or identifiable natural person to whom Personal Information relates; for purposes of this Policy, this refers to you as
the user of the Services.
6. "Device" means any electronic device used to access the Services, including a smartphone, tablet, laptop, or desktop computer.
7. "Expo" means Expo Application Services, including the Expo Push Service used to facilitate push notifications.
8. "Fastify" means the web framework used in our Backend infrastructure through which certain user data is processed and stored.
9. "Mapbox" means Mapbox, Inc., whose software development kit is integrated into the App to provide mapping and location-based functionality.
10. "Personal Information" or "Personal Data" means information that identifies, relates to, describes, is reasonably capable of being associated with, or
could reasonably be linked, directly or indirectly, with a particular consumer, household, or individual, as defined by applicable law.
11. "Processing" means any operation performed on Personal Information, whether by automated means or otherwise, including collection, recording,
organization, structuring, storage, use, transmission, disclosure, retrieval, consultation, combination, restriction, deletion, anonymization, or destruction.
12. "Push Token" or "Device ID" means a unique token generated by a device operating system or messaging provider that allows push notifications to
be delivered to the App on a specific device.
13. "Redemption" means the use by a user of a discount, promotion, or offer made available through the Services.
14. "SDK" means software development kit; in this Policy, this includes, without limitation, the Mapbox Maps SDK.
15. "Sensitive Personal Information" means Personal Information that is considered sensitive under applicable law, including precise geolocation and
other categories expressly regulated by law.
16. "Third-Party Service Provider" or "Processor" means a third party that processes Personal Information on our behalf for a legitimate business
purpose, subject to contractual restrictions and applicable law.
17. "User," "you," or "your" means the individual who accesses or uses the Services.
18. "UUID" means a universally unique identifier generated and assigned within our systems to distinguish a user account.

Scope of This Policy

This Policy applies to Personal Information we collect directly from you, automatically from your use of the Services, from your device, and from service
providers acting on our behalf. This Policy applies solely to the Services and does not apply to any third-party websites, applications, or services that are not
controlled by Sun Ray LLC, even if linked from the Services.

This Policy does not form part of any employment relationship and does not apply to information processed in a context outside consumer use of the Services
unless expressly stated.

Eligibility and Children's Privacy

The Services are not intended for children under thirteen (13) years of age, and we do not knowingly collect Personal Information from children under 13. If we
learn that we have collected Personal Information from a child under 13 without legally sufficient authorization, we will take commercially reasonable steps to
delete such information as soon as practicable.

If you are at least 13 but under 16 years of age, you may use the Services only with the involvement, consent, and supervision of a parent or legal guardian to
...
When you create and maintain an account, we process:

• your full legal name;
• your email address;
• your telephone number;
• internal identifiers, including a UUID and Member ID;
• password hashes and authentication/session tokens; and
• timestamps associated with account creation and updates.

This information is transmitted securely to our Backend and stored in our user account systems for account creation, authentication, password recovery,
account security, and essential service-related communications.

Communication Preferences and Consent Records

We process records relating to your preferences and choices, including:

• your marketing opt-in status for email and push notifications;
• your selected city preference;
• consent timestamps; and
• records of consent withdrawals and related preference changes.

We maintain these records for personalization, compliance, and honoring your communication choices.

Device and Technical Identifiers

When you use the App, we automatically process certain technical information, which may include:

• your Push Token, where you have enabled push notifications;
• Internet Protocol (IP) address;
• User-Agent string;
• device model and operating system version; and
• App version and related diagnostic metadata.

We use this information for notification delivery, account and system security, diagnostics, service operation, fraud prevention, abuse prevention, and rate
limiting.

Location Data

With your device-level permission, the App may access precise GPS coordinates or approximate location to enable map-based functionality in the
"Browse" feature, including displaying your location on the map and sorting nearby businesses by proximity.

We do not transmit, process, or store your precise GPS coordinates on Sun Ray LLC's Backend servers. However, the Mapbox SDK integrated in the App
may directly process your location data, IP address, and telemetry data for map rendering, location services, billing, service integrity, and Mapbox's
product improvement activities in accordance with Mapbox's own privacy documentation.

Usage Data and Analytics

We process data regarding your interactions with the Services, including:

• Redemption history, including business name, discount details, discount amount, redemption city, and timestamp; and
• aggregated and anonymized analytics derived from redemption history, city preferences, and service usage patterns.

This information is used to operate the Services, display your activity history, evaluate service performance, improve offerings, and support lawful business
intelligence activities.

Diagnostic, Security, and Fraud Prevention Data

For security and integrity purposes, we process audit logs containing IP address, User-Agent string, and event metadata when sensitive or privileged
actions occur, including redemptions and member-data lookups. We use this information to detect fraud, investigate incidents, prevent abuse, apply rate
limits, enforce security controls, and protect the Services and users.

Information We Do Not Intentionally Collect

Except as otherwise disclosed in this Policy or required by law, we do not intentionally collect:

• payment card or bank account information;
• photos, videos, audio recordings, or media from your device;
• contacts, calendars, health, fitness, or biometric data;
• browsing history outside the App; or
• advertising identifiers for cross-app or cross-site behavioral advertising.

The App does not include third-party advertising SDKs. Sponsor banners, if any, operate as external links and do not involve advertising pixels or tracking
identifiers controlled by us.

Search queries and favorites activity performed within the App are stored locally on your device and, based on the Services as described in this Policy, are
not transmitted to our Backend.

Purposes of Processing and Legal Bases

We process Personal Information only where we have a lawful basis under applicable law. Depending on your jurisdiction, those legal bases may include the
following:

Performance of a Contract

We process Personal Information as necessary to provide the Services you request, including account creation, authentication, displaying deals,
processing Redemptions, maintaining account records, and sending non-marketing service communications such as password resets and security notices.

Legitimate Interests

We process Personal Information where necessary for our legitimate business interests, provided those interests are not overridden by your rights and
freedoms. These interests include securing the Services, preventing fraud, enforcing our terms, maintaining system stability, diagnosing technical
problems, improving the Services, and analyzing aggregate usage trends.

Consent

We rely on your consent where required by law, including for device-based location access, push notifications, and direct marketing communications where
opt-in is required. You may withdraw consent at any time; however, withdrawal does not affect the lawfulness of processing undertaken before withdrawal.

Compliance with Legal Obligations

We may process Personal Information as necessary to comply with legal obligations, regulatory requirements, lawful requests, recordkeeping duties, court
orders, subpoenas, and law enforcement demands.

Data Sharing, Disclosure, and Third-Party Relationships

No Sale or Sharing for Cross-Context Behavioral Advertising

Sun Ray LLC does not sell, rent, lease, trade, or otherwise disclose your Personal Information to third parties for monetary or other valuable consideration,
and we do not share Personal Information for cross-context behavioral advertising as those terms may be defined under applicable law.

Service Providers

We may disclose Personal Information to a limited number of trusted Third-Party Service Providers that perform services on our behalf. Such providers are
authorized to process Personal Information only as necessary to provide services to us and are contractually required, where applicable, to maintain
appropriate confidentiality and security protections.

• Mapbox, Inc. The App integrates the Mapbox SDK for mapping and location-based functionality. Mapbox may directly process location data, IP
address, device data, app version, session identifiers, and telemetry necessary for map rendering, service delivery, billing, and product improvement
under Mapbox's own privacy policy.
• Expo Application Services. We use Expo Push Service to facilitate push notifications. When we send a notification, we transmit your Push Token and
the notification payload to Expo so that the notification may be delivered to your device.

Corporate Transactions

We may disclose or transfer Personal Information in connection with an actual or proposed merger, acquisition, financing, reorganization, bankruptcy,
receivership, dissolution, sale of company assets, or transition of service to another provider, subject to customary confidentiality restrictions and
applicable law. Where required by law, we will provide notice of a material change affecting your Personal Information.

Legal Compliance and Protection of Rights

We may disclose Personal Information where we believe in good faith that disclosure is necessary to: (a) comply with applicable law, legal process, or
enforceable governmental request; (b) enforce our agreements and policies; (c) detect, prevent, or investigate fraud, abuse, security, or technical issues;
or (d) protect the rights, property, safety, or security of Sun Ray LLC, our users, service providers, or the public.

Where legally permitted and reasonably practicable, we may notify you before making such a disclosure, unless notice is prohibited by law, legal process,
or compelling safety or security considerations.

Disclosure with Your Direction or Consent

We may disclose your Personal Information to additional third parties where you request, direct, or expressly authorize such disclosure.

Third-Party Services and External Links

The Services may contain links to third-party websites, applications, or services not owned or controlled by Sun Ray LLC. We are not responsible for the 
privacy, security, content, or practices of such third parties. Your interactions with third-party services are governed by the applicable third party's own terms
and privacy policy.

For convenience, the privacy policies of certain integrated providers may be found at the following locations, as updated by those providers from time to time:
...
We maintain a commercially reasonable information security program designed to protect Personal Information against unauthorized access, acquisition, use,
disclosure, alteration, and destruction. Our safeguards include administrative, technical, and physical measures appropriate to the nature of the Personal
Information processed and the risks presented.

• Administrative safeguards: access controls, need-to-know restrictions, internal privacy and security procedures, and workforce training.
• Technical safeguards: encryption in transit using industry-standard TLS/SSL, secure authentication controls, input validation, parameterized queries, and
other security-oriented engineering practices.
• Physical safeguards: use of reputable hosting providers with physical security protections for data center environments.

Notwithstanding the foregoing, no method of internet transmission, electronic storage, or security control is guaranteed to be completely secure. Accordingly,
we cannot guarantee absolute security.

In the event of a security incident involving Personal Information, we will take steps required by applicable law, including providing notice to affected
individuals and regulators where legally required.

Data Retention

We retain Personal Information for no longer than is reasonably necessary for the purposes described in this Policy, unless a longer retention period is
required or permitted by law. Retention periods may vary based on the nature of the data, the purpose of processing, legal requirements, operational
necessity, and dispute or enforcement considerations.

• Active account data: retained while your account remains active and as necessary to provide the Services.
• Redemption records and usage data: retained as reasonably necessary to provide activity history, support operations, perform analytics, and satisfy
lawful audit or compliance needs.
• Audit and security logs: retained for a limited period appropriate to fraud prevention, security analysis, abuse prevention, legal compliance, and incident
response.
• Marketing consent records: retained as necessary to document compliance and honor your preferences.
• Backups and archived copies: following account deletion, residual copies may remain in backup systems for a limited period until overwritten in the
ordinary course, subject to legal, security, fraud-prevention, and disaster-recovery needs.
• Anonymous and Aggregate Data: may be retained indefinitely because it is not reasonably capable of identifying you.

Account Deletion and Effect of Deletion Requests

If you request deletion of your account, we will delete or de-identify your Personal Information from active production systems within a commercially
reasonable period, except where retention is necessary or permitted for legal compliance, dispute resolution, fraud prevention, security, tax or accounting
obligations, enforcement of agreements, or other lawful internal purposes compatible with the context in which the information was collected.

Deletion of your account may result in permanent loss of access to account-related features, history, and settings, except to the extent information is retained
as permitted by this Policy and applicable law.

Your Privacy Rights and Choices

Subject to your jurisdiction and applicable law, you may have the following rights with respect to your Personal Information:
...
• the right to request data portability in a structured, commonly used, and machine-readable format, where technically feasible and legally applicable;
• the right to restrict or limit certain processing;
...
To exercise your rights, contact us at sales@lightrailphx.com. We may take reasonable steps to verify your identity before fulfilling a request and may request
additional information necessary to confirm your authority and protect against unauthorized requests.

We will respond within the time required by applicable law. If we deny your request in whole or in part, we will, where required by law, explain the basis for the
denial and provide information about any available appeal process.

Managing Your Choices. You may manage location permissions and push notification settings through your device settings. You may unsubscribe from
marketing emails using the unsubscribe mechanism included in such communications. You may also request account deletion by contacting
sales@lightrailphx.com.

State-Specific Privacy Rights

Residents of certain states, including California, Colorado, Connecticut, Utah, and Virginia, may have additional privacy rights under applicable law. Where
those laws apply, we will honor qualifying requests in accordance with such laws.

California Notice. If you are a California resident, you may have the right to know the categories and specific pieces of Personal Information we have
collected, the sources of that information, the business or commercial purposes for collection, and the categories of third parties to whom we disclose it; the
right to request deletion; the right to request correction; and the right to limit certain uses of Sensitive Personal Information where applicable. As described in
this Policy, we do not sell Personal Information or share Personal Information for cross-context behavioral advertising.

Where required by applicable state law, authorized agents may submit requests on your behalf, subject to verification of identity, authority, and applicable
legal requirements.

International Transfers

The Services are hosted and operated in the United States. If you access the Services from outside the United States, your Personal Information may be
transferred to, stored in, and processed in the United States and potentially other jurisdictions where our service providers operate. Those jurisdictions may
not provide the same level of legal protection as your home jurisdiction.

Where required by applicable law, we will implement appropriate measures for cross-border transfers of Personal Information.

Cookies, SDKs, and On-Device Storage

The App does not use traditional browser cookies in the same manner as a standard website browser environment. However, the Services may use
equivalent technologies, including local device storage and SDKs, for functionality and service improvement.

• On-device storage: the App stores certain information, such as search and favorites data, locally on your device to support functionality and convenience.
• SDKs: the App uses the Mapbox SDK for mapping and related functions and may use operating system or platform services necessary for notifications
and app operation.

We do not use SDKs for cross-app behavioral advertising or third-party ad tracking.

App Platform Disclosures

For mobile app marketplace disclosure purposes:

• Data linked to you: contact information, account identifiers, Redemption history, and certain diagnostics/security data may be linked to your account.
• Data not linked to your Light Rail Deals account by us: location data and certain telemetry processed by Mapbox may not be linked to your Light Rail
Deals account by Sun Ray LLC, although such data may be processed by Mapbox under its own policies.
• Tracking: we do not use data collected through the App to track you across third-party apps or websites for advertising purposes.
• Purposes: data is used for app functionality, personalization, account administration, security, communications, analytics, and service-provider operational
purposes consistent with this Policy.

Do Not Track Signals

Some browsers and devices may transmit "Do Not Track" or similar preference signals. Because there is no universally accepted standard governing such
signals across all technologies used by the Services, the Services do not currently respond to browser-based Do Not Track signals unless and until applicable
law requires otherwise.

Changes to This Policy

We may modify this Policy from time to time to reflect changes in the Services, legal requirements, operational practices, or other legitimate business needs. If
we make material changes, we will provide notice in a manner reasonably calculated to reach affected users, which may include posting the updated Policy on
our website, providing in-app notice, or sending notice to the email address associated with your account where appropriate.

The "Effective Date" at the top of this Policy indicates when the current version became effective. Except where prohibited by law, your continued use of the
Services after the effective date of an updated Policy constitutes your acknowledgment of the revised Policy.

Reservation of Rights and Severability

If any provision of this Policy is held invalid, unlawful, or unenforceable, that provision shall be enforced to the maximum extent permitted by law, and the
remaining provisions shall remain in full force and effect. Any failure by us to enforce any provision of this Policy shall not constitute a waiver of that or any
other provision.

Governing Law and Venue

This Policy and any dispute arising out of or relating to this Policy or the processing of Personal Information by Sun Ray LLC, except to the extent preempted
by applicable federal law or superseded by non-waivable consumer privacy rights under applicable law, shall be governed by the laws of the State of Arizona,
without regard to conflict-of-law principles. Subject to any mandatory rights you may have under applicable law, the state and federal courts located in
Maricopa County, Arizona shall have exclusive jurisdiction over such disputes, and you consent to personal jurisdiction and venue in those courts.

Contact Information

If you have questions about this Policy, our privacy practices, or would like to exercise your privacy rights, you may contact us at:

Sun Ray LLC
Email: sales@lightrailphx.com
Website: lightraildeals.com

We will make commercially reasonable efforts to respond in a timely manner and in accordance with applicable law.
`;
